...
export const Route = createFileRoute("/_app/admin/overview")({
  head: () => ({ meta: [{ title: "Platform overview — Admin" }] }),
  component: AdminOverviewRoute,
});

function AdminOverviewRoute() {
  return (
    <PlatformPermissionRoute permission="platform:metrics_read">
      <AdminOverviewPage />
  ...
  return (
    <div>
      <PageHeader
        ...
        title="Overview"
        description="Platform-wide growth, revenue, plan mix and feature usage."
        actions={
      ...
      <div className="space-y-6 p-4 sm:p-6 md:p-10">
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border bg-card p-6 shadow-soft lg:col-span-2">
            <div className="mb-5 flex flex-wrap items-start justify-between gap-2">
              <div>
                <h2 className="font-display text-lg font-semibold">Signups</h2>
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border bg-card p-6 shadow-soft lg:col-span-2">
            <div className="mb-5 flex flex-wrap items-start justify-between gap-2">
              <div>
                <h2 className="font-display text-lg font-semibold">Revenue collected</h2>
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-soft">
            <div className="mb-5">
              <h2 className="font-display text-lg font-semibold">Revenue by plan</h2>
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-6">
                  ...
                  <div className="mt-3 flex flex-wrap gap-x-6 gap-y-1 text-xs text-muted-foreground">
                    ...
                    <span>
                      ...
                      <span
                        className={cn(
                          "tabular-nums",
                          (data?.health.scheduledPostsFailedInPeriod ?? 0) > 0 &&
                            "text-destructive",
                        )}
                      >
            ...
            <div className="rounded-2xl border bg-card p-6 shadow-soft">
              <div className="mb-4">
                ...
                <p className="text-sm text-muted-foreground">
                  {pendingTotal > 0
                    ? `${formatNum(pendingTotal)} items awaiting review`
                    : "All clear"}
                </p>
              </div>
              {isLoading ? (
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-soft">
            <div className="mb-4">
              <h2 className="font-display text-lg font-semibold">Subscription activity</h2>
