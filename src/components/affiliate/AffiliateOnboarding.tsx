...
import { AffiliateProfitCalculator } from "@/components/affiliate/AffiliateProfitCalculator";
import {
  AFFILIATE_BENEFITS,
      ...
      <section className="surface-card overflow-hidden">
        <div className="p-6 sm:p-8 relative">
          ...
          <div className="relative max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full glass-inset px-3 py-1 text-xs font-medium text-primary mb-4">
            ...
            <Button size="lg" className="mt-6 h-11" onClick={onGetStarted}>
