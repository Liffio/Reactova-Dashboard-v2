  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-7xl font-semibold tracking-tight text-brand-gradient">
          404
        </h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      { charSet: "utf-8" },
      // `viewport-fit=cover` lets the mobile tab bar pad itself with `env(safe-area-inset-bottom)`
      // instead of sitting under the home indicator on notched devices.
      { name: "viewport", content: "width=device-width, initial-scale=1, viewport-fit=cover" },
      { title: "Liffio — Creator OS for Instagram DM automation" },
      {
        name: "description",
        content: "Automate Instagram DMs, capture leads, and track conversions from one workspace.",
      },
      { name: "author", content: "Liffio" },
      { property: "og:title", content: "Liffio — Creator OS" },
      {
        property: "og:description",
        content: "Automate Instagram DMs, capture leads, and track conversions.",
      },
    ...
    links: [
      ...
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      {
        rel: "preload",
        as: "style",
        href: "https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,400;0,14..32,500;0,14..32,600;0,14..32,700&family=JetBrains+Mono:wght@400;500&family=Space+Grotesk:wght@500;600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,400;0,14..32,500;0,14..32,600;0,14..32,700&family=JetBrains+Mono:wght@400;500&family=Space+Grotesk:wght@500;600;700&display=swap",
